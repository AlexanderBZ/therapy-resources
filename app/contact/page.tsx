      ...
      <main className="flex-grow relative">
        ...
        <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <Card className="rounded-3xl shadow-lg overflow-hidden border-t-4 border-primary">
                ...
                <CardContent className="pt-6">
                  <form>
                    <div className="grid w-full items-center gap-6">
                      ...
                      <div className="flex flex-col space-y-1.5">
                        <Input id="email" placeholder="Your Email" type="email" className="rounded-xl" />
                      </div>
                      <div className="flex flex-col space-y-1.5">
                ...
                <CardFooter className="flex justify-between">
                  ...
                  <Button className="rounded-full bg-primary hover:bg-coral">Send Message</Button>
                </CardFooter>
              </Card>
            </div>
            ...
            <div className="space-y-8">
              <div className="bg-white p-6 rounded-3xl shadow-lg">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4">
                    <div className="bg-lavender bg-opacity-20 h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0">
                      <Mail className="h-6 w-6 text-lavender" />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-800">Email Us</h4>
                      <p className="text-primary">hello@smiletherapy.com</p>
                      <p className="text-sm text-gray-500 mt-1">We'll respond within 24 hours</p>
                    </div>
                  </div>

                  <div className="flex items-start gap-4">
                    <div className="bg-mint bg-opacity-20 h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0">
                  ...
                  <div className="flex items-start gap-4">
                    <div className="bg-sunny bg-opacity-20 h-12 w-12 rounded-full flex items-center justify-center flex-shrink-0">
                      <MapPin className="h-6 w-6 text-sunny" />
                    </div>
                    <div>
                      <h4 className="font-medium text-gray-800">Visit Us</h4>
                      <p className="text-primary">123 Happiness Street</p>
                      <p className="text-sm text-gray-500 mt-1">Sunshine City, CA 12345</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-6 rounded-3xl shadow-lg">
                ...
                <p className="text-gray-600 mb-4">
                  Stay connected with us on social media for tips, resources, and uplifting content.
                </p>
